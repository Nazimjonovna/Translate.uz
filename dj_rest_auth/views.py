    ...
    def get_response(self):
        ...
        if getattr(settings, 'REST_USE_JWT', False):
            ...
            if user.is_translator == True:
                serializer.data['user']['is_translator'] = True
                serializer.data['user']['is_lawyer'] = False
                serializer.data['user']['is_client'] = False
            elif user.is_lawyer == True:
                serializer.data['user']['is_lawyer'] = True
                serializer.data['user']['is_translator'] = False
                serializer.data['user']['is_client'] = False
            else:
                serializer.data['user']['is_client'] = True
                serializer.data['user']['is_translator'] = False
                serializer.data['user']['is_lawyer'] = False
